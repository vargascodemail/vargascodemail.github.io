...
const BOOKS = [
  {
    ...
    preco: 'R$ 9,90',
    loja: 'Google Play',
    url: 'https://play.google.com/store/books/details?id=ZJH6EQAAQBAJ',
    disponivel: true,
  },
  {
    ...
    preco: 'R$ 9,90',
    loja: 'Google Play',
    url: 'https://play.google.com/store/books/details?id=cJD6EQAAQBAJ',
    disponivel: true,
  },
  {
    ...
    preco: 'R$ 9,90',
    loja: 'Google Play',
    url: 'https://play.google.com/store/books/details?id=Znr5EQAAQBAJ',
    disponivel: true,
  },
];
...
const CURSOS = [
  {
    ...
    desc: 'Do JavaFX ao JDBC: construa aplicações desktop completas com interfaces gráficas, persistência de dados, padrões MVC, programação concorrente e distribuída.',
  ...
  },
  {
    ...
    subtitulo: 'Paradigma OO · Processos · Requisitos · Casos de Uso · UML',
    desc: 'Análise e projeto de software orientado a objetos com UML: processos de desenvolvimento, requisitos, casos de uso e diagramas de classe.',
    hue: 215, chroma: 0.15, nivel: 'Iniciante', horas: 24, capitulos: 5,
    acesso: 'gratuito', disponivel: true,
    url: 'https://cursos.vargascode.com.br/cursos/curso-as/',
  },
  {
    code: 'JSLOG',
  ...
  },
  {
    ...
    subtitulo: 'Grafos Não Direcionados · Digrafos · AGM · Caminho Mais Curto',
  ...
  },
  {
    ...
    subtitulo: 'Computação Evolutiva · Seleção · Crossover · Mutação',
    desc: 'Resolva problemas de otimização com algoritmos genéticos: inspiração biológica, representação, função de aptidão, seleção, crossover e mutação.',
    hue: 305, chroma: 0.15, nivel: 'Intermediário', horas: 14, capitulos: 7,
    acesso: 'gratuito', disponivel: true,
  ...
  },
  {
    ...
    subtitulo: 'Notação Grande-O · BST · AVL · Tabela Hash',
    desc: 'Meça o custo de um algoritmo antes de escrevê-lo e compare as três estruturas que resolvem busca, inserção e remoção: BST, AVL e tabela hash.',
    hue: 250, chroma: 0.16, nivel: 'Intermediário', horas: 16, capitulos: 4,
    acesso: 'gratuito', disponivel: true,
    url: 'https://cursos.vargascode.com.br/cursos/curso-aa/',
  },
  {
    code: 'WEB',
    nome: 'Aplicações Web',
